...
public class PFPSetActivity {
    ...
    IAsynchProfileSetterListener watcher;



    Bitmap result;

    public PFPSetActivity(int user_id, int session_id, Bitmap bmp, IAsynchProfileSetterListener watcher){
    ...
    public void notify_the_watcher(){
        //TODO you need to add the main form as a watcher at notify it here
        watcher.PFPSetFinished(result);
    ...
    public void set_server_responded(InputStream result){
        ...
        if( resultString.equals("")){
            Log.e("Bitmap", "PFPSetActivity.set_server_responded responce is empty, and shouldn't be");
            this.result = null;
            notify_the_watcher();
            try {
                result.close();
