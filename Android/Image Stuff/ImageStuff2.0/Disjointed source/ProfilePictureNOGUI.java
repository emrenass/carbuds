...
public class ProfilePictureNOGUI implements IAsynchImageConnectionListener{
    ...
    IAsynchProfilePictureListener display;
    Bitmap bitmap;
    ImageConnectionAPI connection;

    public ProfilePictureNOGUI(IAsynchProfilePictureListener display, int owner_id, int target_id, int session_id) throws MalformedURLException {
