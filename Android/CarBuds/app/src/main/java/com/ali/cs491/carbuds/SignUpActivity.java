...
public class SignUpActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mConfirmPasswordView = (EditText) findViewById(R.id.rePassword);
    ...
    private void attemptRegister() {
        ...
        View focusView = null;
        //Check for if confirm password and password is same
    ...
    private boolean arePasswordsSame(String password, String confirm){
    ...
    public class RegisterTask extends AsyncTask<Void, Void, Boolean> {
      ...
      /*      for (String credential : DUMMY_CREDENTIALS) {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Intent intent = new Intent(SignUpActivity.this,TypeSelectionActivity.class);
